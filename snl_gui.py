...
if __name__ == "__main__":
    ...
    remaining_colors = [c for c in all_colors if c != selected_color_value][:1]  # Get only 1 other color
    ...
    gui.player_images = []
    for i in range(2):  # Only 2 players
    ...
    # Add only the AI Easy player (remove AI Medium and AI Hard)
